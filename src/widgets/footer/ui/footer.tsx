...
export function Footer(): ReactNode {
  const { ref, hasIntersected } = useIntersection<HTMLElement>({
    threshold: 0.3,
  });
      ...
      <div className="container">
        ...
        >
          ...
          <motion.div className={styles.brand} variants={variants.fadeInUp}>
            ...
            <p className={styles.tagline}>
              {" "}
              Indigenous liquid rocket engines for the next generation of launch
              vehicles.{" "}
            </p>
          ...
          <div className={styles.linksRow}>
            ...
            >
              ...
              <p>Registered in Prayagraj, Uttar Pradesh </p>
        ...
        >
          <p className={styles.copyright}>
            © {currentYear} Trishul Technology Private Limited. All rights
            reserved.
          </p>
